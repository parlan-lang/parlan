...
* The exacts steps to reproduce the bug
...
If you are ready to write code, here is the quickest way to get your changes merged:

1. **Fork** the repository and create your branch from `main`
2. **Make your changes** (and keep your code clean)
3. **Test your code:** check if the current tests passes, and create new ones if needed
4. **Open a Pull Request** with a clear title and description of what you changed

## Code of Conduct

Our code of conduct is simple: **Be kind, with everyone**

Parlan is a welcoming project for everyone, regardless of experience level. Be respectful, helpful, and patient with anyone

Thank you for helping make Parlan better!
